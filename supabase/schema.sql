...
-- either. Ten original "badge icon" designs (mountain, river, dragon,
-- space, flame, tree, crystal, moon, compass, wave), each a gradient-
-- shaded, drop-shadowed, glossy-highlighted illustration (not flat
-- cartoon fills) so they read as small polished app-icon-style badges.
-- p_seed picks the theme (p_seed mod 10) and, independently, one of 4
-- hue-rotation filters (floor((p_seed-1)/10) mod 4) applied to the
-- whole icon -- since the theme repeats every 10 accounts but the hue
-- rotation only changes every 10 too and in lockstep with theme choice,
-- every one of the default 40 temp accounts (10 themes x 4 hue variants
-- each) ends up with a genuinely distinct-looking badge: same 10 icon
-- designs, but each appears in 4 different colorways.
create or replace function public._temp_avatar_svg(p_seed int)
returns text
language plpgsql
as $BODY$
declare
  v_bg_fills constant text[] := array['url(#bgMtn)', 'url(#bgRiv)', 'url(#bgDrg)', 'url(#bgSpc)', 'url(#bgFlm)', 'url(#bgTree)', 'url(#bgCry)', 'url(#bgMoon)', 'url(#bgCmp)', 'url(#bgWav)'];
  v_bodies constant text[] := array[
  '<circle cx="150" cy="52" r="20" fill="url(#sunG)" filter="url(#softshadow)"/><path d="M15,155 L78,65 L118,112 L155,50 L188,155 Z" fill="url(#peak2)" filter="url(#softshadow)"/><path d="M155,50 L172,78 L138,78 Z" fill="#ffffff"/><path d="M15,155 L78,65 L108,105 L55,155 Z" fill="url(#peak1)"/><path d="M78,65 L96,92 L60,92 Z" fill="#ffffff"/><ellipse cx="95" cy="60" rx="40" ry="14" fill="#ffffff" opacity="0.25" transform="rotate(-25 95 60)"/>',
  '<path d="M0,75 Q40,50 80,75 T160,75 T200,75 V102 Q150,80 100,102 T0,102 Z" fill="url(#w1)" filter="url(#softshadow)"/><path d="M0,112 Q40,90 80,112 T160,112 T200,112 V138 Q150,116 100,138 T0,138 Z" fill="url(#w2)"/><path d="M0,148 Q40,128 80,148 T160,148 T200,148 V172 Q150,150 100,172 T0,172 Z" fill="url(#w3)"/><ellipse cx="60" cy="60" rx="45" ry="10" fill="#ffffff" opacity="0.3" transform="rotate(-15 60 60)"/>',
  '<path d="M60,150 Q40,120 55,95 Q45,80 60,72 Q58,55 78,52 Q80,35 100,42 Q112,25 130,38 Q150,30 155,50 Q170,52 165,70 Q180,75 170,92 Q178,105 160,108 L165,130 L145,118 L142,140 L122,125 L115,148 L98,128 L82,148 L75,125 Z" fill="url(#drgBody)" filter="url(#softshadow)"/><path d="M130,38 Q145,15 165,25 Q155,40 155,50 Z" fill="url(#drgWing)"/><path d="M100,42 Q108,20 125,28 Q118,42 112,50 Z" fill="url(#drgWing)"/><circle cx="152" cy="58" r="4.5" fill="#2b2b2b"/><circle cx="150.5" cy="56" r="1.5" fill="#ffffff"/><path d="M168,68 Q180,66 178,78 Q170,76 168,68 Z" fill="#e0a24d"/><ellipse cx="95" cy="55" rx="40" ry="12" fill="#ffffff" opacity="0.25" transform="rotate(-20 95 55)"/>',
  '<circle cx="150" cy="58" r="26" fill="url(#moonG)" filter="url(#softshadow)"/><circle cx="140" cy="50" r="22" fill="#1f2650"/><circle cx="45" cy="45" r="2.5" fill="#ffffff"/><circle cx="72" cy="88" r="2" fill="#ffffff"/><circle cx="28" cy="105" r="2.2" fill="#ffffff"/><circle cx="105" cy="135" r="1.8" fill="#ffffff"/><circle cx="165" cy="145" r="2.2" fill="#ffffff"/><ellipse cx="58" cy="158" rx="62" ry="18" fill="none" stroke="#e0b96a" stroke-width="2.5" opacity="0.6"/><circle cx="58" cy="158" r="13" fill="url(#planetG)" filter="url(#softshadow)"/><ellipse cx="148" cy="50" rx="10" ry="6" fill="#ffffff" opacity="0.4" transform="rotate(-20 148 50)"/>',
  '<path d="M100,172 C58,172 52,128 74,96 C80,118 96,118 90,90 C112,102 132,128 120,150 C142,138 140,106 124,86 C150,102 156,150 130,166 C162,154 150,106 133,80 C118,54 88,54 88,86 C72,74 68,44 90,24 C58,46 36,88 53,128 C36,140 40,168 100,172 Z" fill="url(#flmOut)" filter="url(#softshadow)"/><path d="M96,160 C79,154 76,132 90,114 C92,128 101,128 97,112 C112,120 121,138 109,152 C124,144 121,120 109,106 C121,116 126,142 109,154 C96,160 96,160 96,160 Z" fill="url(#flmIn)"/><ellipse cx="85" cy="60" rx="20" ry="10" fill="#ffffff" opacity="0.3" transform="rotate(-20 85 60)"/>',
  '<rect x="93" y="150" width="14" height="32" rx="4" fill="#8b6f5c"/><path d="M100,42 L138,105 H62 Z" fill="url(#tr1)" filter="url(#softshadow)"/><path d="M100,74 L143,140 H57 Z" fill="url(#tr2)"/><path d="M100,110 L148,178 H52 Z" fill="url(#tr3)"/><ellipse cx="95" cy="90" rx="30" ry="10" fill="#ffffff" opacity="0.25" transform="rotate(-25 95 90)"/>',
  '<path d="M100,28 L148,76 L120,172 L80,172 L52,76 Z" fill="url(#cA)" filter="url(#softshadow)"/><path d="M100,28 L148,76 L100,92 Z" fill="#e6dcf5"/><path d="M100,28 L52,76 L100,92 Z" fill="url(#cB)"/><path d="M52,76 L100,92 L80,172 Z" fill="url(#cB)"/><path d="M148,76 L100,92 L120,172 Z" fill="url(#cC)"/><ellipse cx="95" cy="55" rx="18" ry="22" fill="#ffffff" opacity="0.4" transform="rotate(-10 95 55)"/>',
  '<path d="M132,38 A56,56 0 1 0 132,162 A46,46 0 1 1 132,38 Z" fill="url(#moonG2)" filter="url(#softshadow)"/><circle cx="56" cy="55" r="2.5" fill="#ffffff"/><circle cx="40" cy="92" r="2" fill="#ffffff"/><circle cx="62" cy="132" r="2.5" fill="#ffffff"/><circle cx="34" cy="152" r="1.8" fill="#ffffff"/><circle cx="90" cy="45" r="1.5" fill="#ffffff"/><ellipse cx="120" cy="55" rx="20" ry="12" fill="#ffffff" opacity="0.3" transform="rotate(-20 120 55)"/>',
  '<circle cx="100" cy="100" r="68" fill="none" stroke="url(#cmpRing)" stroke-width="6" filter="url(#softshadow)"/><circle cx="100" cy="100" r="58" fill="#fffaf0" opacity="0.5"/><path d="M100,42 L114,95 L100,112 L86,95 Z" fill="url(#cmpN)"/><path d="M100,158 L114,105 L100,88 L86,105 Z" fill="url(#cmpS)"/><path d="M42,100 L95,86 L112,100 L95,114 Z" fill="url(#cmpS)"/><path d="M158,100 L105,86 L88,100 L105,114 Z" fill="url(#cmpS)"/><circle cx="100" cy="100" r="7" fill="#c9a34e"/><ellipse cx="75" cy="65" rx="30" ry="12" fill="#ffffff" opacity="0.35" transform="rotate(-20 75 65)"/>',
  '<path d="M0,85 Q40,55 80,85 T160,85 T200,85 V200 H0 Z" fill="url(#wv1)" filter="url(#softshadow)"/><path d="M0,118 Q40,92 80,118 T160,118 T200,118 V200 H0 Z" fill="url(#wv2)"/><path d="M0,150 Q40,128 80,150 T160,150 T200,150 V200 H0 Z" fill="url(#wv3)"/><ellipse cx="60" cy="55" rx="45" ry="12" fill="#ffffff" opacity="0.3" transform="rotate(-15 60 55)"/>'
];
  v_theme_idx int := ((p_seed - 1) % 10) + 1;
  v_hue_idx   int := (((p_seed - 1) / 10) % 4);
  v_svg text;
begin
  v_svg :=
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200"><defs><radialGradient id="bgMtn" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#cfe8fb"/><stop offset="100%" stop-color="#8fc2ec"/></radialGradient><linearGradient id="sunG" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#ffe58a"/><stop offset="100%" stop-color="#ffb648"/></linearGradient><linearGradient id="peak1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#9db3d6"/><stop offset="100%" stop-color="#5c7292"/></linearGradient><linearGradient id="peak2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#b9c8e0"/><stop offset="100%" stop-color="#7a8fae"/></linearGradient><radialGradient id="bgRiv" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#e8fbf7"/><stop offset="100%" stop-color="#bdeee3"/></radialGradient><linearGradient id="w1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#2f9c92"/><stop offset="100%" stop-color="#1e6f68"/></linearGradient><linearGradient id="w2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#57c2b4"/><stop offset="100%" stop-color="#2f9c92"/></linearGradient><linearGradient id="w3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#a6e8dc"/><stop offset="100%" stop-color="#68d3c1"/></linearGradient><radialGradient id="bgDrg" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#f3e9fb"/><stop offset="100%" stop-color="#d9c2f0"/></radialGradient><linearGradient id="drgBody" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#a98ee0"/><stop offset="100%" stop-color="#6f4fb5"/></linearGradient><linearGradient id="drgWing" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#c6aef0"/><stop offset="100%" stop-color="#8a6fd6"/></linearGradient><radialGradient id="bgSpc" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#2a3568"/><stop offset="100%" stop-color="#141a33"/></radialGradient><radialGradient id="moonG" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#fdf6e9"/><stop offset="100%" stop-color="#e3d3ae"/></radialGradient><radialGradient id="planetG" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#f3c76a"/><stop offset="100%" stop-color="#c98f2f"/></radialGradient><radialGradient id="bgFlm" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#fff0e0"/><stop offset="100%" stop-color="#ffd9b8"/></radialGradient><linearGradient id="flmOut" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#ff8a3d"/><stop offset="100%" stop-color="#d4501f"/></linearGradient><linearGradient id="flmIn" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#ffd166"/><stop offset="100%" stop-color="#ff9f3d"/></linearGradient><radialGradient id="bgTree" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#eaf8e6"/><stop offset="100%" stop-color="#c7ecc0"/></radialGradient><linearGradient id="tr1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#57b073"/><stop offset="100%" stop-color="#2f7a48"/></linearGradient><linearGradient id="tr2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#69c085"/><stop offset="100%" stop-color="#3f9a5c"/></linearGradient><linearGradient id="tr3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#7fd096"/><stop offset="100%" stop-color="#4fae6c"/></linearGradient><radialGradient id="bgCry" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#f2e9fb"/><stop offset="100%" stop-color="#dcc4f0"/></radialGradient><linearGradient id="cA" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#d3c2ea"/><stop offset="100%" stop-color="#b39ddb"/></linearGradient><linearGradient id="cB" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#9b80c9"/><stop offset="100%" stop-color="#6f4fb5"/></linearGradient><linearGradient id="cC" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#c0a8e6"/><stop offset="100%" stop-color="#8a6fd6"/></linearGradient><radialGradient id="bgMoon" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#262c56"/><stop offset="100%" stop-color="#141834"/></radialGradient><linearGradient id="moonG2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#fbeecb"/><stop offset="100%" stop-color="#e6cf94"/></linearGradient><radialGradient id="bgCmp" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#fdf6e3"/><stop offset="100%" stop-color="#f3e4b8"/></radialGradient><linearGradient id="cmpN" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#e0645f"/><stop offset="100%" stop-color="#b8342f"/></linearGradient><linearGradient id="cmpS" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#94a8c9"/><stop offset="100%" stop-color="#67809f"/></linearGradient><radialGradient id="cmpRing" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#e6c877"/><stop offset="100%" stop-color="#b98d3a"/></radialGradient><radialGradient id="bgWav" cx="35%" cy="30%" r="75%"><stop offset="0%" stop-color="#e3f4fb"/><stop offset="100%" stop-color="#bfe6f5"/></radialGradient><linearGradient id="wv1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#2f7fa8"/><stop offset="100%" stop-color="#1f5c80"/></linearGradient><linearGradient id="wv2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#4a9dc4"/><stop offset="100%" stop-color="#2f7fa8"/></linearGradient><linearGradient id="wv3" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#8fd0e6"/><stop offset="100%" stop-color="#5db3d4"/></linearGradient><filter id="softshadow" x="-50%" y="-50%" width="200%" height="200%"><feDropShadow dx="0" dy="6" stdDeviation="6" flood-color="#000000" flood-opacity="0.25"/></filter><filter id="hue0"><feColorMatrix type="hueRotate" values="0"/></filter><filter id="hue1"><feColorMatrix type="hueRotate" values="85"/></filter><filter id="hue2"><feColorMatrix type="hueRotate" values="170"/></filter><filter id="hue3"><feColorMatrix type="hueRotate" values="255"/></filter></defs>'
    || '<rect width="200" height="200" rx="28" fill="' || v_bg_fills[v_theme_idx] || '"/>'
    || '<g filter="url(#hue' || v_hue_idx || ')">' || v_bodies[v_theme_idx] || '</g>'
    || '</svg>';

  return 'data:image/svg+xml;base64,' || replace(encode(convert_to(v_svg, 'UTF8'), 'base64'), chr(10), '');
end;
$BODY$;
