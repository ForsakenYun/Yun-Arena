...
export default function TournamentSettingsDialog({ onClose, onSaved }) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center px-4 py-8">
      ...
      <div className="relative w-full max-w-lg max-h-[85vh] flex flex-col bg-panel/95 backdrop-blur-md border border-accent/20 shadow-accent-glow rounded-2xl px-6 py-6 light-glow-card">
